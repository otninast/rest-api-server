...
# {'trainingData':
#     {'training_date': '2019-01-30', 'daily_reflection': '',
#         'self_assessment_score': 3, 'training_image': None},
#  'menuData':
#     {'menu_name': 'All-Out', 'distance': 100, 'style': 'Fr',
#         'time_circle': 60, 'how_many_times': 3},
#  'resultTime':
#     [{'num_of_order': 1, 'result_time': None, 'result_time_str': '010000',
#         'lapTime': [{'num_of_order': 1, 'num_of_lap': 1, 'lap_time': '003000'}]},
#
#      {'num_of_order': 2, 'result_time': None, 'result_time_str': '010100',
#         'lapTime': [{'num_of_order': 2, 'num_of_lap': 1, 'lap_time': '003100'}]},
#
#      {'num_of_order': 3, 'result_time': None, 'result_time_str': '010200',
#         'lapTime': [{'num_of_order': 3, 'num_of_lap': 1, 'lap_time': '003200'}]}]}
#
#
# # #####-------------------------------------------------------------------######
#
#
# {'trainingData':
#     {'training_date': '2019-01-29', 'daily_reflection': None,
#         'self_assessment_score': None, 'training_image': ''},
#  'menuData':
#     {'menu_name': 'menu', 'distance': 100, 'style': 'Fr',
#         'time_circle': 90, 'how_many_times': 3},
#  'resultTime':
#     [{'num_of_order': 1, 'result_time_str': '010390', 'result_time': None,
#         'lapTime': [{'num_of_order': 1, 'num_of_lap': 1, 'lap_time': '003000'}]},
#
#      {'num_of_order': 2, 'result_time_str': '010450', 'result_time': None,
#         'lapTime': [{'num_of_order': 2, 'num_of_lap': 1, 'lap_time': '003000'}]},
